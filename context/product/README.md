...
| [`service-auth.md`](service-auth.md) | How does a scheduled job authenticate, given it cannot sign in as a person? | Specified and ready to build. Step 1 of the pipeline above |
